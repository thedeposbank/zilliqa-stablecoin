...
|`connectFundraisingContract`|`address : ByStr20`| Set new address of fundraising contract. `_sender` must be the current `owner`.| :heavy_check_mark: |
